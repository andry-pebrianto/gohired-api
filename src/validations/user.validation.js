...
const updateProfile = [
  ...
  // address
  check('address', 'Adress maximum length is 100 characters').isLength({ max: 100 }),
  // description
  ...
  // jobDesk
  check('jobDesk', 'Job desk maximum length is 50 characters').isLength({ max: 50 }),
  // jobType
  check('jobType', 'Job type maximum length is 50 characters').isLength({ max: 50 }),
  // companyName
  check('companyName', 'Work place maximum length is 100 characters').isLength({ max: 100 }),
];
